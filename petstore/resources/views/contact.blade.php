...
<div class="container">
    ...
    <h2>Phone</h2>
    <p>You can also call us at <strong>(60) 12-3456789</strong> during our business hours: Monday to Friday, 9 AM - 6 PM.</p>
    
    <h2>Live Chat</h2>
    <p>For immediate assistance, we offer live chat support. Simply click the chat icon at the bottom right of the page, and one of our agents will assist you right away.</p>
    ...
    <h2>Contact Form</h2>
    <p>Alternatively, you can fill out the contact form below, and we’ll get back to you as soon as we can.</p>
